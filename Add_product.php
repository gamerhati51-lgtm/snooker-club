<?php
// PHP Configuration and Setup (Same logic as before, using placeholders)
    ...
    <main class="flex-1 ml-0 lg:ml-64 pt-7 p-8 main-content"> <!-- pt-20 = header height -->
      ...
      <div id="content-area" class="space-y-8 bg-gray-100 p-6 rounded-lg">
            ...
            <form method="POST" action="add_product.php" class="space-y-8 pb-24 mt-3" enctype="multipart/form-data">
                        ...
                        <div class="bg-white p-8 rounded-card shadow-smooth border border-blue-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" id="name" name="name" required 
                                           class="w-full p-4 border border-gray-300 rounded-input bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary shadow-input transition-all duration-200"
                            ...
                            <div class="mt-8">
                                ...
                                <textarea id="description" name="description" 
                                          class="w-full p-4 border border-gray-300 rounded-input bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary shadow-input transition-all duration-200 h-32 resize-none"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" step="0.01" min="0" id="cost_price" name="cost_price" value="10.00" 
                                               class="w-full p-4 pl-10 border border-gray-300 rounded-input bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary shadow-input transition-all duration-200 font-mono text-lg text-right">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" step="0.01" id="margin" name="margin" value="33.33" 
                                               class="w-full p-4 pr-10 border border-gray-300 rounded-input bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary shadow-input transition-all duration-200 font-mono text-lg text-right">
                                    </div>
                                </div>
                            ...
                            <div id="stock-fields" class="space-y-6">
                                <div>
                                    ...
                                    <input type="number" min="0" id="initial_stock" name="initial_stock" value="0" 
                                           class="w-full p-4 border border-gray-300 rounded-input bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary shadow-input transition-all duration-200 font-mono text-center text-lg">
                ...
                <div class="fixed bottom-0 left-0 right-0 lg:ml-64 bg-white p-6 shadow-2xl border-t border-blue-200 flex justify-end space-x-4 z-50">
                    <!-- Option 1: Save & Add Opening Stock -->
                  <!-- Option 1: Save & Add Opening Stock -->
<button type="submit" name="save_and_open_stock" value="1"
    class="flex items-center space-x-2 bg-amber-500 hover:bg-amber-400 text-gray-900 font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
...
<button type="submit" name="save_simple" value="1"
    class="flex items-center space-x-2 bg-green-600 hover:bg-green-500 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
