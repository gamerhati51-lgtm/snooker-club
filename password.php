...
<!-- Main content -->
<div class="flex-1 p-6 ml-64 max-w-md ">
    <h1 class="text-3xl font-bold mb-4 text-center">Admin Settings</h1>

    <?php if(!empty($message)) { ?>
        <p class="mb-4 text-green-600"><?php echo $message; ?></p>
    <?php } ?>
    <?php if(!empty($error)) { ?>
        <p class="mb-4 text-red-600"><?php echo $error; ?></p>
    <?php } ?>
<div class="flex-1 flex items-center justify-center p-6">
    <form method="post" class="space-y-4 bg-white p-8 rounded shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold mb-4 text-center text-green-700">Update Password</h2>
